...
class Planet
{
    ...
    addLocation(scene: any, lat: any, lon: any, name: string, radius: any, labelColor: any): void
    {
        ...
        div.className = 'planetLocationLabel';
        div.textContent = name;
        div.style.textDecorationColor = labelColor;
        const label = new CSS2DObject(div);
        label.position.set(Math.cos(latRad) * Math.cos(lonRad) * radius + 0.15, Math.sin(latRad) * radius + 0.15, Math.cos(latRad) * Math.sin(lonRad) * radius+ 0.25);
...
export const mercuryAtmoSphereTexture = new THREE.ShaderMaterial({
    ...
    uniforms: {
        vColor: {
            value: [0.2, 0.2, 0.2, 1.0] // Za obvivka
        }
    },
...
export const venusAtmoSphereTexture = new THREE.ShaderMaterial({
    ...
    uniforms: {
        vColor: {
            value: [0.6, 0.4, 0.3, 1.0] // Za obvivka
        }
    },
...
export const marsAtmoSphereTexture = new THREE.ShaderMaterial({
    ...
    uniforms: {
        vColor: {
            value: [0.7, 0.2, 0.3, 1.0] // Za obvivka
        }
    },
...
export const jupiterAtmoSphereTexture = new THREE.ShaderMaterial({
    ...
    uniforms: {
        vColor: {
            value: [0.28, 0.22, 0.11, 1.0] // Za obvivka
        }
    },
...
export const saturnAtmoSphereTexture = new THREE.ShaderMaterial({
    ...
    uniforms: {
        vColor: {
            value: [0.87, 0.9, 0.8, 1.0] // Za obvivka
        }
    },
...
export const uranusAtmoSphereTexture = new THREE.ShaderMaterial({
    ...
    uniforms: {
        vColor: {
            value: [0.59, 0.81, 0.91, 1.0] // Za obvivka
        }
    },
...
export const neptuneAtmoSphereTexture = new THREE.ShaderMaterial({
    ...
    uniforms: {
        vColor: {
            value: [0.2, 0.4, 0.84, 1.0] // Za obvivka
        }
    },
...
export function LoadVenus(): any
{
    return new Promise((resolve) => {
        ...
        modelLoader.load('./models/Venus.glb', (object) =>
        {
            ...
            VenusAtmosphere = new Planet(null, venusAtmoSphereTexture, 5.8);
            resolve('Success');
        });
    })
}
...
export function LoadJupiter(): any
{
    return new Promise((resolve) => {
        ...
        modelLoader.load('./models/Jupiter.glb', (object) =>
        {
            ...
            JupiterAtmosphere = new Planet(null, jupiterAtmoSphereTexture, 5.7);
            resolve('Success');
        });
    })
}
...
export function LoadUranus(): any
{
    return new Promise((resolve) => {
        ...
        modelLoader.load('./models/Uranus.glb', (object) =>
        {
            ...
            UranusAtmosphere = new Planet(null, uranusAtmoSphereTexture, 5.45);
            resolve('Success');
        });
    })
}
