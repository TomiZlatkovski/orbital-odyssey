...
function LoadPlanetsLocation(scene: any, planetName: any, labelColor: any)
{
    ...
    switch(planetName)
    {
        case "Mercury":
            {
                const radius = 4.1;
                Planets.Mercury.addLocation(scene, 31.46, 174.15, 'Caloris Montes', radius, labelColor)
            }
            break;
        case "Venus":
            {
        ...
        case "Mars":
            {
                ...
                Planets.Mars.addLocation(scene, 1, 76, 'Hebes Chasma', radius + 0.24, labelColor);
            }
            break;
        case "Jupiter":
            {
